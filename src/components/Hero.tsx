...
const Hero = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#0f172a] via-[#1e293b] to-[#334155] relative overflow-hidden">
      ...
      <main className="container mx-auto min-h-screen px-6 py-10 pt-16 relative z-10">
        <div className="flex flex-col lg:flex-row items-center justify-between gap-16">
          ...
          <div className="w-full lg:w-1/2 text-left">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6 h-16">
              ...
              <span
                className={`inline-block w-2 h-8 ml-1 bg-blue-400 ${
          ...
          <div className="w-full lg:w-1/2 relative flex justify-center lg:justify-end">
            <div
              className={`relative lg:mr-30 z-10 w-64 md:w-80 aspect-square rounded-full border-4 border-blue-500/30 p-2 bg-gradient-to-br from-blue-500/10 to-purple-500/10 backdrop-blur-sm shadow-xl transition-all duration-1000 transform ${
                isImageLoaded ? "scale-100 opacity-100" : "scale-90 opacity-0"
              }`}
            >
